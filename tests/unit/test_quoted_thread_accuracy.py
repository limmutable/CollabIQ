...
def test_quote_removal_accuracy_95_percent(normalizer):
    ...
    print(f"\n{'='*70}")
    print(f"QUOTED THREAD REMOVAL ACCURACY TEST RESULTS")
    print(f"{'='*70}")
...
def test_dataset_quality():
    ...
    korean_cases = sum(1 for case in ACCURACY_TEST_DATASET if any(
    ...
    assert total_cases >= 20, f"Dataset should have at least 20 cases, got {total_cases}"
