...
This module ensures OpenAIAdapter adheres to the LLMProvider interface contract.
...
class TestOpenAIAdapterContract:
    """Contract tests ensuring OpenAIAdapter implements LLMProvider interface."""

    def test_openai_adapter_inherits_from_llm_provider(self, openai_adapter):
        """Verify OpenAIAdapter inherits from LLMProvider."""
        assert isinstance(openai_adapter, LLMProvider)

    def test_openai_adapter_has_extract_entities_method(self, openai_adapter):
        """Verify OpenAIAdapter has extract_entities method."""
